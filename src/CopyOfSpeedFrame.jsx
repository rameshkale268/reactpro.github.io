                    ...
                    <tbody className='center'>

                      {
                        SpeedFrameMc.map((data,index)=>{
                            ...
                            <td><input disabled type="text" className="form-control" value={data} name='sfMcNo' /></td>
                            <td><input type="text" className="form-control" name= "sfRovHk" onChange={inputEvent} /></td>
                            <td><input type="text" className="form-control" name= "sfSpeed"  onChange={inputEvent} /></td>
                            <td><input type="text" className="form-control" name= "sfTPI" onChange={inputEvent} /></td>
                            <td><input
                                disabled
                                type="text"
                                className="form-control"
                            ...
                            <td><input type="text" className="form-control" name= "sfActualHK" onChange={inputEvent} /></td>
                            <td>
                                <input
